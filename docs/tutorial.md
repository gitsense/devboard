...
In boards.json file, add "hello-world.board-1", "hello-world.board-2" and "hello-world.board-3" to the end of the menu.boards and quickLinks.boards array like so:
